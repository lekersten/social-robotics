<<<<<<< Updated upstream:old_code/demo-huggingface-qwen1.5.py
...
def conversation(model_name):
    ...
    prompt = input("\n> ")
    messages = [
        {"role": "system", "content": "You are a person that likes to have a with people about what interests them."},
        {"role": "user", "content": prompt}
    ]
    text = tokenizer.apply_chat_template(
        messages,
...
if __name__ == '__main__':
    ...
    # demo(model_name=model_name)
    conversation(model_name)
>>>>>>> Stashed changes:demo-huggingface-qwen1.5.py
